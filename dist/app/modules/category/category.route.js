...
router.get("/", (0, auth_1.default)(user_enum_1.ENUM_USER_ROLE.ADMIN), category_controller_1.CategoryController.getAllFromDB);
router.post("/create-category", category_controller_1.CategoryController.insertToDB);
